...
export const AuthLayout = () => {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col lg:flex-row font-sans text-slate-900 dark:text-slate-100 overflow-x-hidden animate-fade-in">
      <ToastContainer />

      {/* Left Column: IT360 LMS Enterprise Branding & Value Highlights */}
      <div className="lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-between relative bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950/80 border-b lg:border-b-0 lg:border-r border-slate-700/60 overflow-hidden text-white">
        ...
        <div className="relative z-10">
          <Link to="/" className="inline-flex items-center space-x-3 group">
            ...
            <span className="font-black text-2xl tracking-tight text-white">
              IT360 <span className="text-blue-400 font-bold">LMS</span>
            </span>
          </Link>
        </div>
        ...
        <div className="relative z-10 my-12 lg:my-0 space-y-8 max-w-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="p-4 sm:p-5 rounded-2xl bg-slate-800/80 backdrop-blur-md border border-slate-700/80 space-y-2 shadow-sm">
        ...
        <div className="relative z-10 pt-6 border-t border-slate-700/80">
          <p className="text-xs font-semibold text-slate-300 leading-relaxed tracking-wide">
      ...
      <div className="lg:w-1/2 p-6 sm:p-12 lg:p-16 flex items-center justify-center bg-slate-50 dark:bg-slate-950">
