  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto pb-16">
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-purple-50 border border-purple-200 text-xs font-semibold text-purple-700 mb-2">
            <Sparkles className="w-3.5 h-3.5 mr-1.5 text-purple-600" /> Instructor Evaluation Hub
          </div>
        ...
        <div className="max-w-xs w-full">
          <select
            ...
            className="w-full px-4 py-2.5 rounded-xl border border-slate-300 bg-white text-xs font-semibold text-slate-900 focus:border-indigo-600 outline-none cursor-pointer"
          >
                  ...
                  return (
                    <tr key={sub._id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="p-4 space-y-0.5">
                        <p className="font-semibold text-indigo-600 text-xs">{trainingTitle}</p>
                        ...
                        {sub.submissionType === 'github' && sub.githubUrl && (
                          <div>
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="inline-flex items-center text-xs text-purple-700 font-mono font-semibold hover:underline"
                            >
                      ...
                      <td className="p-4 space-y-1">
                        ...
                        {sub.status === 'reviewed' && (
                          <p className="text-xs font-semibold text-slate-800">
                            Grade: <span className="text-indigo-600 font-bold">{sub.grade || 'Good'}</span>
                          </p>
                        )}
                      </td>
          ...
          <form onSubmit={handleReviewSubmit} className="space-y-5">
              ...
              <div className="pt-2 text-xs space-y-1">
                ...
                {activeSubmission?.submissionType === 'github' && activeSubmission?.githubUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-purple-700 font-mono underline font-semibold flex items-center hover:opacity-80 pt-1"
                  >
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-slate-300 text-xs text-slate-900 focus:border-indigo-600 outline-none resize-none"
              />
            </div>
            ...
            <div className="pt-3 border-t border-slate-200 flex justify-end space-x-3">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-6 py-2 rounded-xl text-xs font-semibold bg-indigo-600 text-white hover:bg-indigo-700 shadow-xs transition-all cursor-pointer"
              >
